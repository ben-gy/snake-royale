 ...
 *
 * Copied from the gh-game-factory patterns/ engine. Snake Royale is played with
 * swipes across the arena canvas, which is exactly the gesture iOS reads as a
 * pan/zoom candidate — the guards below are what keep a swipe a turn.
 */
