/**
 * host-election.test.ts — who hosts a Snake Royale room, and when that is
 * allowed to change. The room's host is the arena's authority (net-game.ts
 * filters it through the round's seats), so getting this wrong stalls the sim
 * for everyone, not just a badge in the lobby.
 *
